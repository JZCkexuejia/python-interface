...
class Ui_SettingsWidget(object):
    def setupUi(self, SettingsWidget):
        ...
        SettingsWidget.resize(1053, 542)
        ...
        self.send_serial_btn = QPushButton(self.paramBox)
        self.send_serial_btn.setObjectName(u"send_serial_btn")

        self.horizontalLayout.addWidget(self.send_serial_btn)
        ...
        self.paramPanel.setGeometry(QRect(0, 0, 927, 106))
    ...
    def retranslateUi(self, SettingsWidget):
        ...
        self.pushButton_open_serial.setText(QCoreApplication.translate("SettingsWidget", u"Open Atrial", None))
        ...
        self.send_serial_btn.setText(QCoreApplication.translate("SettingsWidget", u"Send Serial", None))
